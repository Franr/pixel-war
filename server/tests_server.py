...
class ActionsTest(TestCase):
    ...
    def test_login_blue(self):
        player, _, score, pw_map = create_player(Team.BLUE, self.hcriat)
        self.assertEqual(player.get_team(), 1)

    def test_login_red(self):
        player, _, score, pw_map = create_player(Team.RED, self.hcriat)
    ...
    def test_multiple_players_blue(self):
        player, others, score, pw_map = create_player(Team.BLUE, self.hcriat)
        self.assertEqual(others, [])
        player, others, score, pw_map = create_player(Team.BLUE, self.hcriat)
        self.assertEqual(len(others), 1)

    def test_multiple_players_red(self):
        player, others, score, pw_map = create_player(Team.RED, self.hcriat)
        self.assertEqual(others, [])
        player, others, score, pw_map = create_player(Team.RED, self.hcriat)
        self.assertEqual(len(others), 1)
    ...
    def test_shoot_friend(self):
        player1, _, score, pw_map = create_player(Team.BLUE, self.hcriat)
        player2, _, score, pw_map = create_player(Team.BLUE, self.hcriat)
    ...
    def test_shoot_enemy(self):
        player1, _, score, pw_map = create_player(Team.BLUE, self.hcriat)
        player2, _, score, pw_map = create_player(Team.RED, self.hcriat)
        pw_map.move_player(player2, player1.x+2, player1.y)
    ...
    def test_score_from_red(self):
        player1, _, score, pw_map = create_player(Team.RED, self.hcriat)
        player2, _, score, pw_map = create_player(Team.BLUE, self.hcriat)
