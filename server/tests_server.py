...
class ActionsTest(TestCase):
    ...
    def test_shoot_friend(self):
        player1, others, score, pw_map = create_player(Team.BLUE, self.hcriat)
        player2, others, score, pw_map = create_player(Team.BLUE, self.hcriat)
    ...
    def test_shoot_enemy(self):
        player1, others, score, pw_map = create_player(Team.BLUE, self.hcriat)
        player2, others, score, pw_map = create_player(Team.RED, self.hcriat)
        pw_map.move_player(player2, player1.x+2, player1.y)
    ...
    def test_score_from_red(self):
        player1, others, score, pw_map = create_player(Team.RED, self.hcriat)
        player2, others, score, pw_map = create_player(Team.BLUE, self.hcriat)
